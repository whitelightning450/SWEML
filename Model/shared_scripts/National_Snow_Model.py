...
class SWE_Prediction():
    ...
    def Get_Monitoring_Data(self, getdata = False):
        if getdata ==True:
            GM_template = pd.read_csv(f"{HOME}/SWEML/data/PreProcessed/ground_measures_features_template.csv")
    ...
    def Data_Processing(self, SCA = True):
        ...
        obs_path = f"{HOME}/SWEML/data/PreProcessed/ground_measures_features.h5"
        ...
        GM_path = f"{HOME}/SWEML/data/PreProcessed/DA_ground_measures_features.h5"
    ...
    def SWE_Predict(self):
        ...
        self.Region_optfeatures = pickle.load(
            open(f"{HOME}/SWEML/data/Optimal_Features.pkl", "rb"))
