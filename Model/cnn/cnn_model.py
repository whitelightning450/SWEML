...
def Model_train(cwd, epochs, RegionTrain, RegionTest, RegionObs_Train, RegionObs_Test, Region):
    ...
    model.fit(X_train, y_train, batch_size=6, epochs=epochs, validation_split=0.1,        
...
def Model_predict(cwd, RegionTest, RegionObs_Test, RegionTest_notScaled, Region, model):
    ...
    model_final = model
    y_pred = (SWEmax* model_final.predict(X_test))
