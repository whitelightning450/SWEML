...
#         x = layers.Dense(1)(x)
        ...
        model = svm.SVR() #Shahab added in October 2023
        ...
        dump(model, f"{checkpoint_filepath}best_svm_model.joblib")
...
def Model_predict(cwd, RegionTest, RegionObs_Test, RegionTest_notScaled):
    ...
    for Region in Regions:
     ...
     #Set up model to predict 0" SWE if hasSnow = False
        ...
        model=load(f"{checkpoint_filepath}/best_svm_model.joblib")
       # print(bestmodel)
        #save this model
