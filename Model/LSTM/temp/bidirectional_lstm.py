...
def Model_train(cwd, epochs, RegionTrain, RegionTest, RegionObs_Train, RegionObs_Test, RegionTest_notScaled):
    ...
    for Region in Regions:
        ...
        model.fit(X_train, y_train, batch_size=5, epochs=epochs, 
                                      verbose=0, shuffle='False', callbacks=[callback])  # [es, mc]validation_split=0.2,
