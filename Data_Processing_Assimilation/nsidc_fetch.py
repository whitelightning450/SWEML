...
def download(short_name: str, version: str, temporal:str, bbox:str,
             ...
             mode: str = None,
             format:str = "GeoTIFF",
             subset:str = "/VIIRS_Grid_IMG_2D/CGF_NDSI_Snow_Cover",
    ...
    """
        ...
        Parameters:
            ...
            subset (str): Subset of the data product, defaults to "/VIIRS_Grid_IMG_2D/CGF_NDSI_Snow_Cover", must be comma separated
